#!/usr/bin/env python3
"""Module that calculates the likelihood of obtaining data given
various hypothetical probabilities using a binomial distribution."""
import numpy as np
...
def likelihood(x, n, P):
    ...
    Returns:
        1D numpy.ndarray containing the likelihood of obtaining the
